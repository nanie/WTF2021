...
namespace WTF.Player
{
    ...
    public partial class WTFPlayerView : View
    {
        private WTFPlayerController Controller => _controller;
        private WTFPlayerController _controller;
        public  WTFPlayerControllerEvents Events => _controller.Events;
        public  WTFPlayerViewModel Data => _data;
        private readonly WTFPlayerViewModel _data = new WTFPlayerViewModel();
        ...
        {
            _controller = MVCApplication.Controllers.Get<WTFPlayerController>();
        }
