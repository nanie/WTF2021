...
namespace WTF.PlayerInput
{
    ...
    public partial class WTFPlayerInputView : View
    {
        private WTFPlayerInputController Controller => _controller;
        private WTFPlayerInputController _controller;
        public  WTFPlayerInputControllerEvents Events => _controller.Events;
        public  WTFPlayerInputViewModel Data => _data;
        private readonly WTFPlayerInputViewModel _data = new WTFPlayerInputViewModel();
        ...
        {
            _controller = MVCApplication.Controllers.Get<WTFPlayerInputController>();
        }
