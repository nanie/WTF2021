...
namespace WTF.PlayerInput
{
    ...
    public partial class WTFPlayerInputMVCComponent : MVCComponent
    {
        private WTFPlayerInputView View => BaseOwnerView as WTFPlayerInputView;
        // Access Events from here. Please, use Observer pattern, people who uses Observer patterns are nice people.
        public  WTFPlayerInputControllerEvents Events => View.Events;
        public override Type GetViewType()
        {
            return typeof(WTFPlayerInputView);
        }
        ...
        {
            BaseOwnerView = view as WTFPlayerInputView;
